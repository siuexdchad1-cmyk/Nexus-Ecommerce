...
export const LiquidChrome = ({
  ...
  useEffect(() => {
    ...
    // Stretch canvas element to cover the container completely
    ...
    function resize() {
      const scale = 0.5; // Render at 50% resolution to save fill-rate/GPU memory
      renderer.setSize(container.offsetWidth * scale, container.offsetHeight * scale);
      
      // Force the canvas element to fill the container completely
      gl.canvas.style.width = '100%';
      gl.canvas.style.height = '100%';
